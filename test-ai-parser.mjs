// Test script for the updated AI parser service - ES Module version

// Notify test is starting
console.log("Starting AI Parser test script");

// Import the AI parser service
import { parseTimetableWithChuteAI } from './src/services/aiParserService.js';

// Run the test when module is loaded
console.log("AI Parser service imported, running test...");
